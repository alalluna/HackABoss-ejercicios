package lunes16Verdura;

import lunes16Verdura.Entities.Verdura;
...
public class Main {
    public static void main(String[] args) {
        ...
        verduras[1] = new Verdura(2, "verde", "pimiento", 40, false);
        verduras[2] = new Verdura(3, "blanca", "colifor", 25, true);
        verduras[3] = new Verdura(4, "verde", "espinacas", 23, true);
        verduras[4] = new Verdura(5, "verde", "tomate", 18, false);
        ...
        //system.out.println(verdura.toStringPersonalizado())
